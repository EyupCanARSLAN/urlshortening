...
namespace Common
{
    /*This code blocks get from:
     * https://github.com/EyupCanARSLAN/OutKillerProject/blob/master/ServiceResponse/ServiceResponce.cs
    */
    /// <summary>
    ...
    public class ServiceResult<T>
    {
        ...
        /// <summary>
        /// ServiceMessageCode that can be use when status is fail.
        /// </summary>
        public int? FailMessageCode { get; set; }
        /// <summary>
        ...
        /// <returns></returns>
        public static ServiceResult<T> FailResponse(string failMessage = null, int? serviceMessageCode = null, T failedData = default(T)) => ServiceResponse(ServiceResultStatus.Fail, failedData, failMessage, serviceMessageCode);
        /// <summary>
        ...
        /// <returns></returns>
        private static ServiceResult<T> ServiceResponse(ServiceResultStatus serviceResult, T data = default(T), string message = null, int? failMessageCode = null) => new ServiceResult<T>
        {
            Status = serviceResult,
            Message = message,
            Data = data,
            FailMessageCode=failMessageCode
